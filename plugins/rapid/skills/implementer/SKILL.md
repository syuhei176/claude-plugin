...
- `TASKS.md` - Task list
- `specs/[capability]/spec.md` - Specification documents (requirements and scenarios)
- `specs/[capability]/design.md` - Design documents (if exists)
- `specs/project.md` - Project conventions
...
- **Spec is source of truth**: Implementation MUST match `spec.md` exactly
- Implement ONLY what's specified - don't add extra features
- Follow scenarios in `spec.md` precisely (WHEN/THEN/AND)
- Use conventions from `specs/project.md`
...
2. Read `specs/[capability]/spec.md` for requirements and scenarios
3. Read `specs/[capability]/design.md` if exists for technical patterns
4. Read `specs/project.md` for project conventions
5. If first task, setup development environment (linter/formatter)
6. **Implement to match spec exactly** - spec is source of truth
7. Run linter and fix issues
8. Run formatter
9. Run tests and verify they pass
10. Run build check
11. Update TASKS.md with completion
12. Report to user
